...
class Cdss::TestGroundWater < Minitest::Test
  def setup
  ...
  def test_get_well_measurements
    VCR.use_cassette('cdss_get_well_measurements') do
      ...
      assert_equal reading.well_id, 149733
      assert_kind_of Float, reading.depth_to_water unless reading.depth_to_water.nil?
      assert_kind_of Float, reading.measuring_point_above_land_surface unless reading.measuring_point_above_land_surface.nil?
